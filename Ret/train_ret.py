...
def main():
    ...
    parser.add_argument('--model_save_dir', dest='model_save_dir', default='./model_metal_ret', help='directory to save the model during training.')
    parser.add_argument('--model_to_test', dest='model_to_test', default='./model_metal_ret_LR1e-05_BSIZE128', help='path of the model to test')
    parser.add_argument('--result_save_file', dest='result_save_file', default='metal_ret_test.json')
